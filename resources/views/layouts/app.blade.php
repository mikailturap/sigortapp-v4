...
<head>
    ...
    <style>
        ...
        /* Şık ve Belirgin Tab Tasarımı - GÜÇLÜ */
        .nav-tabs-line {
        ...
        .nav-tabs-line .nav-link:hover i {
            opacity: 1 !important;
        ...
        @keyframes pulse {
            0% { box-shadow: 0 12px 35px rgba(0, 123, 255, 0.3); }
            50% { box-shadow: 0 12px 35px rgba(0, 123, 255, 0.5); }
            100% { box-shadow: 0 12px 35px rgba(0, 123, 255, 0.3); }
        }
...
<body class="bg-light">
    ...
    <!-- Bootstrap JS already included via Vite (resources/js/app.js). Removed duplicate CDN include to avoid conflicts. -->
